...
import {OperationFormData} from "../components/dialogs/CreateOperationDialog";

export const adaptOperationPayload = (formData: OperationFormData, toothDetailsForm: ToothDetailForm[]) => ({
