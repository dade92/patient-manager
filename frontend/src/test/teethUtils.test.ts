...
describe('teethUtils', () => {
    describe('generateFdiTeethNumbers', () => {
        test('should generate correct permanent teeth numbers for upper jaw', () => {
    ...
    describe('generateFdiDeciduousTeethNumbers', () => {
        test('should generate correct deciduous teeth numbers for upper jaw', () => {
